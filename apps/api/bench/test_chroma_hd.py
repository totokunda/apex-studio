...
json_path = "/home/tosin_coverquick_co/apex-studio/apps/api/apex-test-suite/image/chroma-hd-text-to-image-1.0.0.v1.json"
...
engine = UniversalEngine(
    yaml_path="/home/tosin_coverquick_co/apex-studio/apps/api/new_manifest/image/chroma-hd-text-to-image-1.0.0.v1.yml",
    selected_components={
        "vae": {
            "variant": "default"
        },
