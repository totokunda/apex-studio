...
class Graphormer_Hand_Network(torch.nn.Module):
    ...
    def forward(
        self, images, mesh_model, mesh_sampler, meta_masks=None, is_train=False
    ):
        ...
        template_vertices, template_3d_joints = mesh_model.layer(
            template_pose, template_betas
        )
