...
from src.transformer.seedvr.base.mlp import get_mlp
from src.transformer.seedvr.base.mm import MMArg, MMModule
...
from src.transformer.seedvr.base.rope import RotaryEmbedding3d
...
class MMWindowAttention(nn.Module):
    ...
    def forward(
        ...
        txt_out = attention_register.call(
            txt_q,
