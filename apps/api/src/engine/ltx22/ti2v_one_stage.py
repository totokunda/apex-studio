    ...
    def run(
        ...
        **kwargs,
        ...
        if last_image is not None:
            ...
            last_image, new_height, new_width = self._aspect_ratio_resize(last_image, max_area=int(height * width), mod_value=64)
        ...
        if image is not None:
            ...
            image, new_height, new_width = self._aspect_ratio_resize(image, max_area=int(height * width), mod_value=64)
