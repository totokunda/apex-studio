...
from src.vae.ltx2audio.resnet import LRELU_SLOPE, ResBlock1
...
@helper_registry("ltx2.vocoder_bwe")
class VocoderWithBWE(ModelMixin, ConfigMixin):
    ...
    def __init__(
        ...
        self.bwe_generator = Vocoder(**bwe)
        self.mel_stft = MelSTFT(**mel_stft)
