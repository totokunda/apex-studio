...
class AnimeSegmentation:
    def __init__(self, ckpt_path):
        ...
        self.net.load_state_dict(
            {k.replace("net.", ""): v for k, v in sd.items() if k.startswith("net.")}
        )
    ...
    def get_mask(self, input_img, s=640):
        ...
        if s == 0:
            ...
            with torch.no_grad():
                pred = self.net(tmpImg)[0][
                    0
                ].sigmoid()  # https://github.com/SkyTNT/anime-segmentation/blob/main/train.py#L92C20-L92C47
