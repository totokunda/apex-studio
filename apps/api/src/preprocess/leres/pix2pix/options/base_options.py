...
class BaseOptions:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument(
            "--name", type=str, default="void", help="mahdi_unet_new, scaled_unet"
        )
        parser.add_argument(
            "--gpu_ids",
            type=str,
        ...
        parser.add_argument(
            "--load_size", type=int, default=672, help="scale images to this size"
        )
        parser.add_argument(
            "--crop_size", type=int, default=672, help="then crop to this size"
        )
        parser.add_argument(
            "--max_dataset_size",
            type=int,
        ...
        parser.add_argument(
            "--depthNet", type=int, required=False, help="0: midas 1:strurturedRL"
        )
