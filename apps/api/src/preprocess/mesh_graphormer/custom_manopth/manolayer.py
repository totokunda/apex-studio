...
from src.preprocess.mesh_graphormer.custom_manopth.smpl_handpca_wrapper_HAND_only import (
    ready_arguments,
)
from src.preprocess.mesh_graphormer.custom_manopth import (
    rodrigues_layer,
    rotproj,
    rot6d,
)
from src.preprocess.mesh_graphormer.custom_manopth.tensutils import (
    th_posemap_axisang,
    th_with_zeros,
    th_pack,
    subtract_flat_id,
...
class ManoLayer(Module):
    ...
    def __init__(
        ...
        self.register_buffer(
            "th_v_template", torch.Tensor(smpl_data["v_template"]).unsqueeze(0)
        )
        self.register_buffer(
