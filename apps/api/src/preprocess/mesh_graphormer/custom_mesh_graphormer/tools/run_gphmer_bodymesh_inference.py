        ...
        for image_file in image_list:
            if "pred" not in image_file:
                ...
                (
                    ...
                    hidden_states,
                    att,
                ) = Graphormer_model(batch_imgs, smpl, mesh_sampler)
                ...
                visual_imgs_output = visualize_mesh(
                    renderer,
                    batch_visual_imgs[0],
...
def visualize_mesh(renderer, images, pred_vertices_full, pred_camera):
    ...
    rend_img = visualize_reconstruction_no_text(
        img, 224, vertices_full, cam, renderer, color="light_blue"
    )
