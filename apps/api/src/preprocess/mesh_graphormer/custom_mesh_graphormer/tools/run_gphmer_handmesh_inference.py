...
from custom_mesh_graphormer.modeling.hrnet.hrnet_cls_net_gridfeat import (
    ...
    with torch.no_grad():
        for image_file in image_list:
            if "pred" not in image_file:
                ...
                pred_3d_pelvis = pred_3d_joints_from_mesh[
...
def parse_args():
    ...
    parser.add_argument(
        "--image_file_or_path", default="./samples/hand", type=str, help="test data"
    )
    #########################################################
