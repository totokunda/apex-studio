...
from src.transformer.seedvr.base.embedding import TimeEmbedding
from src.transformer.seedvr.base.modulation import get_ada_layer
from src.transformer.seedvr.base.nablocks import get_nablock
...
class SeedVR2Transformer3DModel(ModelMixin, ConfigMixin, PeftAdapterMixin, FromOriginalModelMixin, CacheMixin):
    ...
    def __init__(
        ...
        num_layers: int,
        block_type: Optional[Union[str, Tuple[str]]] = None,
...
class SeedVR2Transformer3DModelUpscaler(nn.Module):
    """
