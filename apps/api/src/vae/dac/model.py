...
from src.vae.dac.base import CodecMixin
from src.vae.dac.nn.layers import Snake1d
from .nn.layers import WNConv1d
from src.vae.dac.nn.layers import WNConvTranspose1d
from src.vae.dac.nn.quantize import ResidualVectorQuantize
from src.vae.dac.nn.vae_utils import DiagonalGaussianDistribution
...
class DAC(ModelMixin, CodecMixin, ConfigMixin):
