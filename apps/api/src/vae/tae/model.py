...
class TAEHV(ModelMixin, ConfigMixin):
    ...
    def __init__(self, 
        ...
        self.is_cogvideox = checkpoint_path is not None and "taecvx" in checkpoint_path or model_type == "cogvideox"
    ...
    def decode(self, latents, return_dict=None, cond=None):
        return (self.decode_video(latents.transpose(1, 2), parallel=False).transpose(1, 2),)
