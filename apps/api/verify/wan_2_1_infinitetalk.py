...
prompt = (
    "A man barks like a dog and snarls loudly, with a menacing expression on his face.",
)
...
for variant in variants:
    out_path = os.path.join(
        dir_path,
        f"test_wan_21_infinitetalk_14b_{variant.lower()}_fusion_lora_sage_4steps_bark.mp4",
    )
