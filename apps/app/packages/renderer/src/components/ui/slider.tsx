...
>(({ className, ...props }, ref) => (
  <SliderPrimitive.Root
    ...
    {...props}
  >
    <SliderPrimitive.Track className="relative h-0.5 group-hover/slider:h-1 w-full grow overflow-hidden transition-all duration-200 rounded-full bg-primary/20">
