...
const MediaModelTrigger:React.FC<MediaModelTriggerProps> = ({ onClick, icon, title, section, onOpen }) => {
  ...
  return (
    <div onClick={handleClick} className={cn("flex flex-row font-medium items-center justify-center border border-transparent px-2.5 py-1.5 gap-x-1.5 rounded  text-brand-light/60  transition-all duration-200 cursor-pointer",{
