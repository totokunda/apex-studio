  ...
  return (
    <div className="p-4 px-5 min-w-0 pb-6">
      <div className="flex flex-row items-center justify-between mb-4">
        <h4 className="text-brand-light text-[12px] font-medium text-start">Effects</h4>
        <span
          onClick={resetAll}
      ...
      <div className="flex flex-col gap-y-2">
        <PropertiesSlider label="Sharpness" value={sharpness} onChange={setSharpness} min={0} max={100} step={1} toFixed={0}  />
        <PropertiesSlider label="Noise" value={noise} onChange={setNoise} min={0} max={100} step={1} toFixed={0}  />
        <PropertiesSlider label="Blur" value={blur} onChange={setBlur} min={0} max={100} step={1} toFixed={0}  />
        <PropertiesSlider label="Vignette" value={vignette} onChange={setVignette} min={0} max={100} step={1} toFixed={0}  />
      </div>
    </div>
  )
}
