...
const TextBackgroundSection: React.FC<TextBackgroundSectionProps> = ({ clipId }) => {
        ...
        <div className="flex flex-col gap-y-4 p-4 px-5 border-t border-brand-light/5">
            <div className="flex flex-row items-center gap-x-3">
                <Checkbox
                    ...
                    onCheckedChange={(checked) => updateClip(clipId, { backgroundEnabled: !!checked })}
                />
            ...
            {backgroundEnabled && (
                <div className="flex flex-col gap-y-4 pl-7 pb-3">
                    <ColorInput
                        ...
                        setPercentValue={(value) => updateClip(clipId, { backgroundOpacity: value })}
                    ...
                    <PropertiesSlider
                        ...
                        onChange={(value) => updateClip(clipId, { backgroundCornerRadius: value })}
                        suffix="px"
                        min={0}
                        max={50}
                        step={1}
