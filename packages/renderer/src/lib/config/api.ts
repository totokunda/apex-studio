 ...
 */
export async function getBackendApiUrl(): Promise<ConfigResponse<BackendUrlConfig>> {
 ...
 */
export async function setBackendApiUrl(url: string): Promise<ConfigResponse<BackendUrlConfig>> {
 ...
 */
export async function getApexHomeDir(): Promise<ConfigResponse<HomeDirectoryConfig>> {
 ...
 */
export async function setApexHomeDir(homeDir: string): Promise<ConfigResponse<HomeDirectoryConfig>> {
 ...
 */
export async function getApexTorchDevice(): Promise<ConfigResponse<TorchDeviceConfig>> {
 ...
 */
export async function setApexTorchDevice(device: string): Promise<ConfigResponse<TorchDeviceConfig>> {
 ...
 */
export async function getApexCachePath(): Promise<ConfigResponse<CachePathConfig>> {
 ...
 */
export async function setApexCachePath(cachePath: string): Promise<ConfigResponse<CachePathConfig>> {
